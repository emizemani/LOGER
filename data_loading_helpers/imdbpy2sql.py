...
class _BaseCache(dict):
    ...
    def flush(self, quiet=0, _recursionLevel=0):
        ...
        if _recursionLevel >= MAX_RECURSION:
            print('WARNING: recursion level exceeded trying to flush data')
        ...
        if self._tmpDict:
            ...
            try:
                ...
                print('WARNING: Exception caught during commit:')
                print(e)
                traceback.print_exc()
        ...
        try:
            ...
            print('WARNING: Exception caught during final commit:')
            print(e)
            traceback.print_exc()
...
def doMovieCompaniesInfo():
    """Files with information on a single line about movies, concerning companies."""
    ...
    for dataf in (('distributors.list.gz', DIS_START),
        ...
        for line in fp:
            try:
                # Decode line from bytes to string, ignoring errors
            ...
            try:
                ...
                print(f"ERROR: Exception caught while processing line: {line}")
                print(f"Exception: {e}")
                import traceback
                traceback.print_exc()
        ...
        try:
            ...
            print(f"ERROR: Exception caught while flushing SQLData: {e}")
            import traceback
            traceback.print_exc()
        fp.close()
